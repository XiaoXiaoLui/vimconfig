...
elseif &background=='dark' 
  ...
  elseif &t_Co==256
    ...
    if v:version >= 700
      ...
      hi TabLine	ctermfg=Black	ctermbg=250	cterm=NONE
      hi TabLineFill	ctermfg=fg	ctermbg=Black	cterm=NONE
      hi TabLineSel	ctermfg=Black	ctermbg=DarkCyan	cterm=NONE
      hi TabLineModified    ctermfg=Black ctermbg=Yellow    cterm=NONE
